...
const Navbar = ()=>{
    ...
    return(
        <nav className="theme-bg-accent w-1/5 h-screen">
            <div className="flex flex-row mt-20 justify-evenly items-center">
                <Image width="60%" height="60%" src={logo} /><p className="theme-text font-medium text-2xl">Open Nova</p>
            </div>
