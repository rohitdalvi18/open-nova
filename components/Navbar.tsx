    ...
    return(
        <nav className="theme-bg-accent w-1/5 h-screen">
            <div className="flex flex-row mt-20 justify-center items-center">
                <Image width="45%" height="45%" src={logo}/><p className="ml-3 theme-text font-medium text-2xl">OpenNova</p>
            </div>
            <ul className="mt-48 flex flex-col items-start pl-8 theme-text font-medium text-xl">
                ...
                <li className={"mb-7 w-full py-2 pl-5 rounded-l-2xl" + checkIfActive("new-tweet")}>
